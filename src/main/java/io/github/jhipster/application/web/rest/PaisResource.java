...
public class PaisResource {
     ...
     */
    @GetMapping("/pais")
    public ResponseEntity<List<Pais>> getAllPais(PaisCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<Pais>> searchPais(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
