...
public class GruposResource {
     ...
     */
    @GetMapping("/grupos")
    public ResponseEntity<List<Grupos>> getAllGrupos(GruposCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<Grupos>> searchGrupos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
