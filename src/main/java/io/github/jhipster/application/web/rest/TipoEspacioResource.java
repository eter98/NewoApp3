...
public class TipoEspacioResource {
    ...
    public ResponseEntity<List<TipoEspacio>> getAllTipoEspacios(TipoEspacioCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<TipoEspacio>> searchTipoEspacios(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
