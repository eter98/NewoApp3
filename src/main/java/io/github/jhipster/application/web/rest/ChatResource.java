...
public class ChatResource {
     ...
     */
    @GetMapping("/chats")
    public ResponseEntity<List<Chat>> getAllChats(ChatCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<Chat>> searchChats(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
