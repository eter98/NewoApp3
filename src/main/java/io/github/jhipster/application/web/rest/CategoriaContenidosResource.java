...
public class CategoriaContenidosResource {
    ...
    public ResponseEntity<List<CategoriaContenidos>> getAllCategoriaContenidos(CategoriaContenidosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<CategoriaContenidos>> searchCategoriaContenidos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
