...
public class MargenNewoEventosResource {
    ...
    public ResponseEntity<List<MargenNewoEventos>> getAllMargenNewoEventos(MargenNewoEventosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<MargenNewoEventos>> searchMargenNewoEventos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
