...
public class LandingResource {
     ...
     */
    @GetMapping("/landings")
    public ResponseEntity<List<Landing>> getAllLandings(LandingCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<Landing>> searchLandings(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
