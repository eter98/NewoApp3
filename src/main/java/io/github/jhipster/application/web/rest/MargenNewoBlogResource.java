...
public class MargenNewoBlogResource {
    ...
    public ResponseEntity<List<MargenNewoBlog>> getAllMargenNewoBlogs(MargenNewoBlogCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<MargenNewoBlog>> searchMargenNewoBlogs(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
