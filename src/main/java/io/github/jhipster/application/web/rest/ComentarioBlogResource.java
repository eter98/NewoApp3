...
public class ComentarioBlogResource {
    ...
    public ResponseEntity<ComentarioBlog> createComentarioBlog(@Valid @RequestBody ComentarioBlog comentarioBlog) throws URISyntaxException {
    ...
    public ResponseEntity<ComentarioBlog> updateComentarioBlog(@Valid @RequestBody ComentarioBlog comentarioBlog) throws URISyntaxException {
    ...
    public ResponseEntity<List<ComentarioBlog>> getAllComentarioBlogs(ComentarioBlogCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<ComentarioBlog>> searchComentarioBlogs(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to search for a page of ComentarioBlogs for query {}", query);
        Page<ComentarioBlog> page = comentarioBlogService.search(query, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(uriBuilder.queryParams(queryParams), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }
