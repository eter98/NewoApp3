...
public class MiembrosGrupoResource {
    ...
    public ResponseEntity<List<MiembrosGrupo>> getAllMiembrosGrupos(MiembrosGrupoCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<MiembrosGrupo>> searchMiembrosGrupos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
