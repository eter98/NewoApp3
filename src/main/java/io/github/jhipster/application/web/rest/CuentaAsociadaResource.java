...
public class CuentaAsociadaResource {
    ...
    public ResponseEntity<List<CuentaAsociada>> getAllCuentaAsociadas(CuentaAsociadaCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<CuentaAsociada>> searchCuentaAsociadas(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
