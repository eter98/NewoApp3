...
public class TipoRecursoResource {
    ...
    public ResponseEntity<List<TipoRecurso>> getAllTipoRecursos(TipoRecursoCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<TipoRecurso>> searchTipoRecursos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
