...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.ChatsListado}.
 */
@RestController
@RequestMapping("/api")
public class ChatsListadoResource {
    ...
    public ResponseEntity<List<ChatsListado>> getAllChatsListados(ChatsListadoCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<ChatsListado>> searchChatsListados(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
