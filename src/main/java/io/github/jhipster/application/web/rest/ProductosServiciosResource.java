...
public class ProductosServiciosResource {
    ...
    public ResponseEntity<List<ProductosServicios>> getAllProductosServicios(ProductosServiciosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<ProductosServicios>> searchProductosServicios(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
