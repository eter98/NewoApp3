...
public class RecursosFisicosResource {
    ...
    public ResponseEntity<List<RecursosFisicos>> getAllRecursosFisicos(RecursosFisicosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<RecursosFisicos>> searchRecursosFisicos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
