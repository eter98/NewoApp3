...
public class MiembrosEquipoEmpresasResource {
    ...
    public ResponseEntity<List<MiembrosEquipoEmpresas>> getAllMiembrosEquipoEmpresas(MiembrosEquipoEmpresasCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<MiembrosEquipoEmpresas>> searchMiembrosEquipoEmpresas(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
