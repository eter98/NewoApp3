...
public class EntradaInvitadosResource {
    ...
    public ResponseEntity<List<EntradaInvitados>> getAllEntradaInvitados(EntradaInvitadosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<EntradaInvitados>> searchEntradaInvitados(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
