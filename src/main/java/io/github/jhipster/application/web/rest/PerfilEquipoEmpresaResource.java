...
public class PerfilEquipoEmpresaResource {
    ...
    public ResponseEntity<List<PerfilEquipoEmpresa>> getAllPerfilEquipoEmpresas(PerfilEquipoEmpresaCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<PerfilEquipoEmpresa>> searchPerfilEquipoEmpresas(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
