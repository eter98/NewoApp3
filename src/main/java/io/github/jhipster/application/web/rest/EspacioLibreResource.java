...
public class EspacioLibreResource {
    ...
    public ResponseEntity<List<EspacioLibre>> getAllEspacioLibres(EspacioLibreCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<EspacioLibre>> searchEspacioLibres(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
