...
public class RegistroCompraResource {
    ...
    public ResponseEntity<List<RegistroCompra>> getAllRegistroCompras(RegistroCompraCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<RegistroCompra>> searchRegistroCompras(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
