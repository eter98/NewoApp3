...
public class TipoPrepagoConsumoResource {
    ...
    public ResponseEntity<List<TipoPrepagoConsumo>> getAllTipoPrepagoConsumos(TipoPrepagoConsumoCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<TipoPrepagoConsumo>> searchTipoPrepagoConsumos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
