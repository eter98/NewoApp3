...
public class MargenNewoProductosResource {
    ...
    public ResponseEntity<List<MargenNewoProductos>> getAllMargenNewoProductos(MargenNewoProductosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<MargenNewoProductos>> searchMargenNewoProductos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
