...
public class PrepagoConsumoResource {
    ...
    public ResponseEntity<List<PrepagoConsumo>> getAllPrepagoConsumos(PrepagoConsumoCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<PrepagoConsumo>> searchPrepagoConsumos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
