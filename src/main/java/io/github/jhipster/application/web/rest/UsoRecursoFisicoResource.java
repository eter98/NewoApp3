...
public class UsoRecursoFisicoResource {
    ...
    public ResponseEntity<List<UsoRecursoFisico>> getAllUsoRecursoFisicos(UsoRecursoFisicoCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<UsoRecursoFisico>> searchUsoRecursoFisicos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
