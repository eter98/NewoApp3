...
public class ComentarioFeedResource {
    ...
    public ResponseEntity<List<ComentarioFeed>> getAllComentarioFeeds(ComentarioFeedCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<ComentarioFeed>> searchComentarioFeeds(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
