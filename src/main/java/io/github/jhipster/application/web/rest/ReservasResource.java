...
public class ReservasResource {
     ...
     */
    @GetMapping("/reservas")
    public ResponseEntity<List<Reservas>> getAllReservas(ReservasCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<Reservas>> searchReservas(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
