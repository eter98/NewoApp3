...
public class EquipoEmpresasResource {
    ...
    public ResponseEntity<List<EquipoEmpresas>> getAllEquipoEmpresas(EquipoEmpresasCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<EquipoEmpresas>> searchEquipoEmpresas(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
