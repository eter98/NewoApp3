...
public class ConsumoMarketResource {
    ...
    public ResponseEntity<List<ConsumoMarket>> getAllConsumoMarkets(ConsumoMarketCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<ConsumoMarket>> searchConsumoMarkets(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
