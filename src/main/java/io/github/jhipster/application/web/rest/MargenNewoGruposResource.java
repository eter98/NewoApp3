...
public class MargenNewoGruposResource {
    ...
    public ResponseEntity<List<MargenNewoGrupos>> getAllMargenNewoGrupos(MargenNewoGruposCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<MargenNewoGrupos>> searchMargenNewoGrupos(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
