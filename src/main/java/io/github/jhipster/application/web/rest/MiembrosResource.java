...
public class MiembrosResource {
     ...
     */
    @GetMapping("/miembros")
    public ResponseEntity<List<Miembros>> getAllMiembros(MiembrosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<Miembros>> searchMiembros(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
