...
public class EntradaMiembrosResource {
    ...
    public ResponseEntity<EntradaMiembros> createEntradaMiembros(@Valid @RequestBody EntradaMiembros entradaMiembros) throws URISyntaxException {
    ...
    public ResponseEntity<EntradaMiembros> updateEntradaMiembros(@Valid @RequestBody EntradaMiembros entradaMiembros) throws URISyntaxException {
    ...
    public ResponseEntity<List<EntradaMiembros>> getAllEntradaMiembros(EntradaMiembrosCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<EntradaMiembros>> searchEntradaMiembros(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
