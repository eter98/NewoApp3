...
public class EspaciosReservaResource {
    ...
    public ResponseEntity<List<EspaciosReserva>> getAllEspaciosReservas(EspaciosReservaCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    */
    ...
    public ResponseEntity<List<EspaciosReserva>> searchEspaciosReservas(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
