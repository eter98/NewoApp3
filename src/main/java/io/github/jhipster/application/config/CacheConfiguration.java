...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, io.github.jhipster.application.domain.ChatsListado.class.getName());
            createCache(cm, io.github.jhipster.application.domain.ChatsListado.class.getName() + ".chats");
            createCache(cm, io.github.jhipster.application.domain.ChatListGrupo.class.getName());
            createCache(cm, io.github.jhipster.application.domain.ChatListGrupo.class.getName() + ".chatGrupos");
